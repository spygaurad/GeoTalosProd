...
class ProjectMemberService:
    ...
    async def list_project_members(
        ...
        logger.debug(
            "list_project_members project_id=%s user_id=%s limit=%s offset=%s total=%s",
            project_id,
            user_id,
            limit,
            offset,
    ...
    async def get_project_member(self, project_id: UUID, user_id: UUID) -> ProjectMember:
    ...
    async def update_project_member(
        self, project_id: UUID, user_id: UUID, payload: ProjectMemberUpdate
    ) -> ProjectMember:
    ...
    async def delete_project_member(self, project_id: UUID, user_id: UUID) -> None:
        member = await self.get_project_member(project_id, user_id)
